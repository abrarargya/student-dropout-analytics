...
with st.form("prediction_form"):
    ...
    with col1:
        ...
        # FIX: Gunakan value manual (misal 6 SKS), jangan ambil dari defaults yang nilainya 0 (scaled)
        sem1_units = st.number_input("SKS Diambil (Sem 1)", min_value=0, value=20)
        sem1_appr = st.number_input("SKS Lulus (Sem 1)", min_value=0, value=20)
    ...
    with col5:
        # value=20 (Manual) agar tidak error karena defaults['Age'] nilainya 0 (akibat scaling)
